...
import java.util.List;
	...
	public class ServiceStation implements Serializable
	{
		...
		public static final String billFilePath="bill.dat";
		public static final String custFilePath="customer.dat";
		...
		private LinkedList<Bill> billList;
		 ...
		 private List<ServiceRequest> allServiceRequests = new ArrayList<>(); // Initialize the list

		    // Other existing methods...

		    public List<ServiceRequest> getServiceRequestsByDate(Date date) {
		        List<ServiceRequest> requests = new ArrayList<>();
		        for (ServiceRequest request : allServiceRequests) {
		            if (isSameDay(request.getRequestDate(), date)) {
		...
		public void newCustomer(Customer c)
		{
		 ...
		 public ServiceRequest newRequest(String customerName, String vehicleNumber) {
		        // Assuming we create a new request with the current date
		        ServiceRequest request = new ServiceRequest(new Date(), customerName, vehicleNumber);
